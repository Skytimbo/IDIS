...
## Recent Changes
- **July 2025**: Fixed PDF text extraction reliability by implementing comprehensive OCR fallback in UnifiedIngestionAgent - enhanced PDF processing now handles image-based PDFs that require OCR with proper error handling and document cleanup
